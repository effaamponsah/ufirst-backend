...
- **Each module** has: service.py (public interface), models.py, routes.py, repository.py, events.py
...
- Migrations are per-module: `migrations/wallet/`, `migrations/identity/`, etc.
